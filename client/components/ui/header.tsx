...
import { Clover, Layout, LogOut, Map, Plus, User, MessageCircle } from "lucide-react";
...
export default function Header() {
  ...
  const [unreadCount, setUnreadCount] = useState(0); // For message notifications
  const [isChatOpen, setIsChatOpen] = useState(false); // Chat state management
